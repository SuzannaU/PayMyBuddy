...
INSERT INTO PayMyBuddy.transactions (sender_id, receiver_id, description, amount, fee)
VALUES (1, 2, 'Paiement du déjeuner', 25.00, 0.00),
       (2, 3, 'Remboursement du cinéma', 15.00, 0.00),
       (1, 2, 'Partage des courses', 50.00, 0.00);
